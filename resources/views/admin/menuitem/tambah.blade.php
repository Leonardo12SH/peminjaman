...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 id="token" class="m-0 text-dark">Tambah Menu Item {{ Auth::user()->name_212102 }}</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-lg-12">
                <form action="{{ route('menu-item.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="menu" name="menu_id_212102" required>
                            ...
                            @forelse ($menus as $menu)
                                <option value="{{ $menu->id_212102 }}">{{ strtoupper($menu->name_212102) }}</option>
                            @empty
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="jenis_menu" name="name_212102" placeholder="Masukkan Jenis Menu" required>
                    </div>

                    <div class="form-group">
                        <label for="price">Harga</label>
                        <input type="number" class="form-control" id="price" name="price_212102" placeholder="Masukkan Harga" min="0" required>
                    </div>
...
<script>
    $(document).ready(function() {
        console.log("Form Menu Item Loaded");
    });
</script>
@endsection
